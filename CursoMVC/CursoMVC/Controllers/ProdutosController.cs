...
namespace CursoMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            ViewData["CategoriaId"] = new SelectList(_context.Categoriras, "Id", "Descricao");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Quantidade,CategoriaId")] Produto produto)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categoriras, "Id", "Descricao", produto.CategoriaId);
            return View(produto);
        }
